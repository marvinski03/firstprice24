# Release Notes for FirstPrice24

## v1.0.6 (2019-01-30)

### TODO

- Please save all changes made to FirstPrice24 before executing the update. All changes will be reset during the update process.
...
- Due to an error, result fields weren't loaded correctly from FirstPrice24. This has been fixed.
...
- Plugin files to make FirstPrice24 compatible with Ceres 3.0.0.
