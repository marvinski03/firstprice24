...
2. Klicken Sie auf **FirstPrice24**.<br /> → Das Plugin wird geöffnet.
...
2. Wählen Sie den Bereich **Stylesheet (FirstPrice24)**.
...
**FirstPrice24** ermöglicht es Ihnen die Templates von **Ceres** mit Ihren eigenen Inhalten zu überschreiben. Geben Sie dafür Ihren Template-Code im Template ein und überschreiben Sie das Template. Dies wird nachfolgend am Beispiel der Startseite erklärt. Richten Sie andere Templates analog ein.
