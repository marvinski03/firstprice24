...
2. Click on **FirstPrice24**.<br /> → The plugin will open.
...
2. Go to the **Stylesheet (FirstPrice24)** area.
...
**FirstPrice24** allows you to override the templates of **Ceres** with your own content. To do so, enter the code in the template and override the template. In the following, setting up the homepage is explained. Set up the other templates the same way.
